...
* **Audit of the robot pipeline**
    * *Action:* From my fresh perspective, provide a feedback on the robot pipeline ur3e-control
    * *Artefacts:* [Report file](https://toys-r-us-rex.github.io/Duckify/architecture/robot/audit/2026-03-18.pdf)

* **Handling of small color artefacts**
    * *Action:* Handle small color artefacts (remove) to avoid tracing undrawable island
    * *Artefacts:* [PR link](https://github.com/Toys-R-Us-Rex/Duckify/pull/74)

* **Fill slicing debugging**
    * *Action:* Solve bugs found concerning the fill slicing
    * *Artefacts:* [PR link](https://github.com/Toys-R-Us-Rex/Duckify/pull/74)

    * **Create dataset of traces**
    * *Action:* From a demand by the team robot, create multiples motives in Blender then Traces files for tests with the robot
    * *Artefacts:* [PR link](https://github.com/Toys-R-Us-Rex/Duckify/pull/82)
